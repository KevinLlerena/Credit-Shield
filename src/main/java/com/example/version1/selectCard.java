...
public class selectCard extends AppCompatActivity {
    ...
    public void createCard(String[] cardList, int num,int listSize){
        ...
        for(int i=num;i<listSize;i++) {
            ...
            cardParams.setMargins(32, 16, 32, 32);
            ...
            final String[] loadCards = cardProp(cardList[num++]);
            String autoFill = loadCards[0]+"\n"+loadCards[1]+"\n"+loadCards[2]+"\n"+loadCards[3]+"\n"+loadCards[4];
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent =  new Intent(selectCard.this, priorityMode.class);
                    intent.putExtra("Bank",loadCards[0]);
                    intent.putExtra("APR",loadCards[1]);
                    intent.putExtra("Balance",loadCards[2]);
                    intent.putExtra("Due",loadCards[3]);
                    intent.putExtra("minDue",loadCards[4]);
